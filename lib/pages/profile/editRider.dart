...
class EditRider extends StatefulWidget {
  const EditRider({super.key, required this.rider});
  final Rider rider;
...
class _EditRiderState extends State<EditRider> {
  ...
  Widget displayImage() {
    ...
    } else if (widget.rider.image != null) {
  ...
  void submitForm() async {
    if (image != null) {
      widget.rider.image = await Rider.saveImage(image!);
    }
    if (formKey.currentState!.validate()) {
      Rider rider = Rider(
        ...
        address: addressController.text,
          ...
          gender: gender == 'male',
          image: widget.rider.image);

      var res = await FirestoreService.updateRider(rider, widget.rider.id!);
